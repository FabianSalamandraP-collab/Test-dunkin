...
export function ResultScreen() {
  ...
  const handleShare = () => {
    const shareText =
      "Ya descubri mi match Dunkin. Haz el test y mira cual te sale a ti.";
    ...
    <div className="min-h-screen bg-[#f4eee7] px-3 py-3 sm:px-5 sm:py-5">
      <div className="relative mx-auto max-w-[1360px] overflow-hidden rounded-[2rem] bg-[linear-gradient(180deg,#f8f4ef_0%,#fbf8f4_100%)] shadow-[0_30px_80px_rgba(89,53,17,0.12)]">
        ...
        <motion.div
          ...
          className="bg-white/75 relative overflow-hidden rounded-[1.8rem] px-4 py-5 shadow-[0_24px_55px_rgba(89,53,17,0.08)] ring-1 ring-[#ECE2D8] sm:rounded-[2rem] sm:px-8 sm:py-7 lg:px-10 lg:py-10"
        >
          ...
          <div className="relative flex flex-col gap-3 md:grid md:grid-cols-[0.96fr_0.84fr] md:items-center md:gap-7 lg:grid-cols-[0.95fr_0.85fr] xl:gap-10">
            <div className="space-y-3 text-left md:space-y-7">
              <div className="rounded-[1.35rem] border border-[#EEE1D4] bg-[linear-gradient(180deg,rgba(255,252,248,0.92)_0%,rgba(252,246,239,0.98)_100%)] p-3.5 shadow-[0_16px_30px_rgba(89,53,17,0.05)] md:space-y-3 md:rounded-none md:border-0 md:bg-transparent md:p-0 md:shadow-none">
                <div className="inline-flex rounded-full border border-[#F2D8C4] bg-[#FFF3E8] px-3 py-1 text-[0.64rem] font-bold uppercase tracking-[0.16em] text-[#B86B2C] shadow-[0_8px_18px_rgba(89,53,17,0.05)] sm:text-[0.68rem]">
                  Tu match Dunkin
                </div>
                ...
                <h1 className="max-w-[13rem] text-[1.62rem] font-black uppercase leading-[0.86] tracking-[-0.05em] text-[#FF7A00] sm:max-w-none sm:text-[3rem] md:text-[2.8rem] lg:text-[3.35rem] xl:text-[3.7rem]">
                  {result.title}
                </h1>
                ...
                <div className="mt-3 space-y-3 md:hidden">
                  <div className="relative mx-auto flex w-full max-w-[250px] items-center justify-center rounded-[1.8rem] border border-[#E8D7C8] bg-[linear-gradient(180deg,rgba(255,251,246,0.98)_0%,rgba(247,237,226,0.98)_100%)] px-5 pb-4 pt-5 shadow-[0_18px_34px_rgba(89,53,17,0.08),inset_0_1px_0_rgba(255,255,255,0.56)]">
                    <div
                      className="absolute left-1/2 top-6 h-[118px] w-[118px] -translate-x-1/2 rounded-full opacity-85 blur-[1px]"
                      style={{
                    ...
                    <div className="absolute bottom-4 left-1/2 h-5 w-[64%] -translate-x-1/2 rounded-[999px] bg-[#C98F5C]/14 blur-md" />
                    {!resultImageHidden && result.image ? (
                      <img
                        src={result.image}
                        alt={result.recommendedDrink}
                        className="relative z-10 max-h-[144px] w-auto object-contain drop-shadow-[0_18px_24px_rgba(87,45,0,0.14)]"
                        onError={() => setResultImageHidden(true)}
                      />
                    ) : (
                      <div className="relative z-10 flex h-[150px] w-[110px] items-end justify-center rounded-[1.45rem] bg-[linear-gradient(180deg,#f6dfc7_0%,#d49755_100%)] shadow-[0_16px_24px_rgba(140,81,24,0.14)]">
                  ...
                  <div className="space-y-2 rounded-[1.15rem] border border-[#F0E1D4] bg-[linear-gradient(180deg,#FFF8F2_0%,#FFF2E6_100%)] p-3 shadow-[0_12px_24px_rgba(89,53,17,0.05)]">
              ...
              <div className="hidden space-y-2 rounded-[1.15rem] border border-[#F0E1D4] bg-[linear-gradient(180deg,#FFF8F2_0%,#FFF2E6_100%)] p-3.5 shadow-[0_12px_24px_rgba(89,53,17,0.05)] md:block md:space-y-2.5 md:rounded-[1.5rem] md:p-5">
                ...
                <p className="rounded-[0.9rem] bg-white/72 px-3 py-2 text-[0.7rem] font-medium leading-[1.3] text-[#8C6856] sm:text-[0.82rem]">
                  Una opción ideal para acompanar tu mood.
                </p>
              </div>
            </div>
        ...
        >
          <div className="rounded-[1.35rem] bg-[#F7EDE3] px-3.5 py-3.5 ring-1 ring-[#EADDCF] sm:rounded-[1.7rem] sm:px-6 sm:py-5">
          ...
          <Button
            ...
            className="w-full rounded-full px-7 py-3 shadow-[0_18px_30px_rgba(255,122,0,0.22)] lg:w-auto lg:self-center lg:py-3.5"
          >
            {benefitData.cta}
          </Button>
        </motion.div>
        ...
        {formSubmitted && (
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="space-y-3 rounded-[1.35rem] border border-[#EADDCF] bg-[linear-gradient(180deg,#FFF8F2_0%,#FFF2E8_100%)] p-4 shadow-[0_18px_34px_rgba(89,53,17,0.06)] sm:p-5">
              <div className="space-y-1.5">
                ...
                <p className="max-w-[620px] text-[0.84rem] leading-6 text-[#6B5B4F] sm:text-[0.96rem]">
                  Ya tienes tu match Dunkin. Compartelo con tu parche.
                </p>
              </div>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <Button
                  size="lg"
                  onClick={handleShare}
                  className="w-full rounded-full py-4 text-base shadow-[0_18px_30px_rgba(255,122,0,0.22)] sm:text-lg"
                >
                ...
                <Button
                  ...
                  className="w-full rounded-full border-[#E8DCCF] bg-white/92 py-4 text-base text-[#4A281B] shadow-none sm:text-lg"
                >
